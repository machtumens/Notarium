...
**Phase 4 pre-condition RESOLVED (2026-08-21):** the SRS-hardening stream committed separately at
`e14e0b2` before Phase 4's EXECUTE ran — `I-chat-study.test.ts`'s G2.1 split was re-verified fresh
